...
typedef void (^getSynchronyDataConfigCallback)(GF_RET_CODE resp, int sampleRate, int channelMask, int packageSampleCount, int resolutionBits, double conversionK);
...
-(GF_RET_CODE)getImpedanceDataConfig:(getSynchronyDataConfigCallback)cb timeout:(NSTimeInterval)timeout;
...
-(GF_RET_CODE)getImpedanceDataCap:(getSynchronyDataCapCallback)cb timeout:(NSTimeInterval)timeout;
...
-(GF_RET_CODE)setImpedanceDataConfig:(int)sampleRate channelMask:(int)channelMask sampleCount:(int) sampleCount resolutionBits:(int)resolutionBits cb:(onlyResponseCallback)cb timeout:(NSTimeInterval)timeout;
